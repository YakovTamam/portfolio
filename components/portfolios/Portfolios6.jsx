    ...
    <div className="tmp-portfolio-area" id="portfolio">
      <div className="inner">
        <div className="section-head text-align-left mb--50">
          <h5 className="pre-title mb--20">Portfolio</h5>

          <h2 className="title split-collab tmp-scroll-trigger tmp-fade-in animation-order-2">
            Selected Projects & Real-World Systems
          </h2>

          <p className="description tmp-scroll-trigger tmp-fade-in animation-order-3">
            A selection of projects I've built, ranging from full-stack
            platforms to AI-driven systems and production-ready applications.
            Each project reflects my approach to building scalable, efficient,
