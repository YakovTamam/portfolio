        ...
        <div className="tmp-contact-about-inner">
          ...
          <div className="content">
            <div className="title-area">
              <h4 className="title">Yakov-Eliya Tamam</h4>
            ...
            <div className="description">
              <div className="info-box">
                <span className="phone">
                  Phone:
                  <a href="tel:053-2266676">053-2266676</a>
                </span>
                <span className="mail">
                  Email:
                  <a href="mailto:Yaakovt100@gmail.com">Yaakovt100@gmail.com</a>
                </span>
              </div>
            </div>
            <div className="social-area mb--30">
              <div className="social-link justify-content-center">
                <a href="https://www.instagram.com/yakov_eliya_tamam/">
                  <i className="fa-brands fa-instagram" />
                </a>
                <a href="https://www.linkedin.com/in/yakov-tamam/">
                  <i className="fa-brands fa-linkedin-in" />
                </a>

                <a href="https://www.facebook.com/yakov.eliya.tamam">
